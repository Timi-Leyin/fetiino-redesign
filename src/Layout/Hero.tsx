    ...
    <motion.section id="hero" className='flex min-h-screen justify-around items-center relative'>
      <div className="">
        ...
        <h1 className='text-6xl font-[400]'>
          ...
          <span className="block">sliky <span className='font-[300]'>Gradient</span> </span>
        ...
        <div className="">
            ...
            <div className="flex gap-2">
                ...
                <Button className='rounded-full ring-black text-black ring-1 bg-transparent mx-2 flex align-center justify-center'> <ReadIcon /> <span className="mx-1">Read Article</span> </Button>
            </div>
            {/* tools extension */}
        </div>
      </div>
